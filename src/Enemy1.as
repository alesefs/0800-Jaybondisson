package  
{
	...
	{
		[Embed(source = "../assets/Enemy1.png")] private var ImgEnemy1:Class;
		...
		//colisao coins
		[Embed(source = "../assets/ataquemob1.mp3")] protected var ataquemob1:Class;
		

		public function Enemy1(X:Number, Y:Number, ThePlayer:Player) 
		{
			super(X, Y);
			loadGraphic(ImgEnemy1, true, true, 32.7, 64);
			...
			addAnimation("normal", [8, 9, 10, 11], 3);
			addAnimation("attack", [13, 14, 15, 14], 3);
			addAnimation("hurt", [12, 12], 10);
        ...
        {	
			...
			if (_player.x > x - 30 && _player.x < x + 30 && _player.y < y + 5 && _player.y > y - 5)
			{
				...
				{
					FlxG.play(ataquemob1, 0.5, false);
					_sound_counter = 0;
				}
			}	
			else
